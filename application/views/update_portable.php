                        ...
                        <div class="modal-body mx-3">
                            ...
                            <table id ="1" cellspacing="1" cellpadding="1" border="1">
                                ...
                                <tr>
                                    ...
                                    <td style="width:10%;height:50px" align="centre"><input type="text" class="form-control validate" name="con_1" value="<?php echo $p->conc_1 ?>"></td>
                                    <td style="width:10%;height:50px" align="centre"><input type="text" class="form-control validate" name="con_2" value="<?php echo $p->conc_2 ?>"></td>
                                    <td style="width:10%;height:50px" align="centre"><input type="text" class="form-control validate" name="con_3" value="<?php echo $p->conc_3 ?>"></td>
                                    <td style="width:10%;height:50px" align="centre"><input type="text" class="form-control validate" name="con_4" value="<?php echo $p->conc_4 ?>"></td>
                                    <td style="width:10%;height:50px" align="centre"><input type="text" class="form-control validate" name="con_5" value="<?php echo $p->conc_5 ?>"></td>
                                    <td style="width:10%;height:50px" align="centre"><input type="text" class="form-control validate" name="con_6" value="<?php echo $p->conc_6 ?>"></td>
                                    <td style="width:10%;height:50px" align="centre"><input type="text" class="form-control validate" name="con_7" value="<?php echo $p->conc_7 ?>"></td>
                                </tr>

                                <tr>
                                    <td style="width:30%;height:50px" align="centre">MOLE %</td>
                                    <td style="width:10%;height:50px" align="centre"><input type="text" class="form-control validate" name="mole_1" value="<?php echo $p->mole_1 ?>"></td>
                                    <td style="width:10%;height:50px" align="centre"><input type="text" class="form-control validate" name="mole_2" value="<?php echo $p->mole_2 ?>"></td>
                                    <td style="width:10%;height:50px" align="centre"><input type="text" class="form-control validate" name="mole_3" value="<?php echo $p->mole_3 ?>"></td>
                                    <td style="width:10%;height:50px" align="centre"><input type="text" class="form-control validate" name="mole_4" value="<?php echo $p->mole_4 ?>"></td>
                                    <td style="width:10%;height:50px" align="centre"><input type="text" class="form-control validate" name="mole_5" value="<?php echo $p->mole_5 ?>"></td>
                                    <td style="width:10%;height:50px" align="centre"><input type="text" class="form-control validate" name="mole_6" value="<?php echo $p->mole_6 ?>"></td>
                                    <td style="width:10%;height:50px" align="centre"><input type="text" class="form-control validate" name="mole_7" value="<?php echo $p->mole_7 ?>"></td>
                                </tr>
