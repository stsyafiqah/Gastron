                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header text-center">
                             ...
                             <form id="wizard-clickable" class="frm_wizard frm_wizard_check" method="POST" action="<?=site_url('insert_warranty')?>" enctype="multipart/form-data"  novalidate>
                            <div class="modal-body mx-3">
                                ...
                                <div class="md-form mb-3">
                                    <!--<i class="fa fa-pencil prefix grey-text"></i>
                                    <label data-error="wrong" data-success="right" for="form8">Client</label>-->
                                    <select class="form-control validate" name="war_type" placeholder="Technician">
